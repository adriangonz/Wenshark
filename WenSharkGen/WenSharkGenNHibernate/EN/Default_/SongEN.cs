...
{
        this.init (id, fname, mime, artist, album, playlist, name, created, type, genre, publication);
}


public SongEN(SongEN song)
{
        this.init (song.Id, song.Fname, song.Mime, song.Artist, song.Album, song.Playlist, song.Name, song.Created, song.Type, song.Genre, song.Publication);
}
